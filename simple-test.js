...
async function testValidSearch() {
  ...
  try {
    ...
    logTestResult('Valid Search Payload', 'FAIL', 'Status 200', { error: error.message });
    return false;
  }
}
...
async function runTests() {
  console.log('Starting simple tests for debug server...\n');
  ...
  passedTests += await testValidSearch() ? 1 : 0;
